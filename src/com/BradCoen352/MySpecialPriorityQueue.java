...
public class MySpecialPriorityQueue {
    ...
    private Node[] elements = new Node[10]; //elements from 1 to N
    ...
    public MySpecialPriorityQueue(int initialCapacity){
        n = 0;
   ...
   // public MySpecialPriorityQueue(){this(1);}
    ...
    public int getSizeOfArray(){ return size;}
    public void setSizeOfArray(int size){this.size = size;}
    public int getMinimumWordFrequency(){return elements[1].getValue();}
    public String getMinimumWord(){return elements[1].getKey();}
    public Node popMin(){
        if(isEmpty()){
